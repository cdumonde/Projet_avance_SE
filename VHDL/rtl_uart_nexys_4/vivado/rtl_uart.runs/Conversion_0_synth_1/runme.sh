...
HD_PWD='/home/cedric/Documents/Cours_2A/Toto/Projet_avance_SE/VHDL/rtl_uart_nexys_4/vivado/rtl_uart.runs/Conversion_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Conversion_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Conversion_0.tcl
