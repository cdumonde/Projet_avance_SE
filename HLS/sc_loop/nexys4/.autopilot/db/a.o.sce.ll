...
define void @"Conversion::do_conversion"(i1* %clk, i1* %reset, i8* %e, i8* %s) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !61), !dbg !366
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !367), !dbg !366
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !368), !dbg !366
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !378), !dbg !366
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !388
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !390
  call void (...)* @_ssdm_op_SpecInterface(i8* %e, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !391
  call void (...)* @_ssdm_op_SpecInterface(i8* %s, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !392
  call void (...)* @_ssdm_op_SpecProcessDef([11 x i8]* @p_str, i32 2, [14 x i8]* @p_str6) nounwind, !dbg !393
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str7), !dbg !394
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str5) nounwind, !dbg !395
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !396
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !397), !dbg !396
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !399
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str7, i32 %tmp_1), !dbg !400
  br label %1, !dbg !401

; <label>:1                                       ; preds = %1, %0
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !402), !dbg !410
  %tmp_3 = call i8 @_ssdm_op_Read.ap_fifo.volatile.i8P(i8* %e), !dbg !419
  call void @llvm.dbg.value(metadata !{i8 %tmp_3}, i64 0, metadata !421), !dbg !411
  call void @llvm.dbg.value(metadata !{i8 %tmp_3}, i64 0, metadata !422), !dbg !417
  %tmp = call i7 @_ssdm_op_PartSelect.i7.i8.i32.i32(i8 %tmp_3, i32 1, i32 7)
  %x = call i8 @_ssdm_op_BitConcatenate.i8.i7.i1(i7 %tmp, i1 false), !dbg !423
  call void @llvm.dbg.value(metadata !{i8 %x}, i64 0, metadata !424), !dbg !423
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !425), !dbg !431
  call void @_ssdm_op_Write.ap_fifo.volatile.i8P(i8* %s, i8 %x), !dbg !439
  br label %1, !dbg !441
}
...
define weak void @"Conversion::Conversion"(i1* %clk, i1* %reset, i8* %e, i8* %s) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %e), !map !53
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %s), !map !57
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !442), !dbg !445
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !446), !dbg !445
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !447), !dbg !445
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !448), !dbg !445
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !449), !dbg !455
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !456), !dbg !460
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !461), !dbg !468
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !469), !dbg !473
  call void (...)* @_ssdm_op_SpecInterface(i8* %e, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !474
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str5, i32 4, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i8* %e) nounwind, !dbg !476
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !477), !dbg !482
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !483), !dbg !487
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !488), !dbg !495
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !496), !dbg !500
  call void (...)* @_ssdm_op_SpecInterface(i8* %s, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !501
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str5, i32 5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i8* %s) nounwind, !dbg !503
  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @p_str, [11 x i8]* @p_str) nounwind, !dbg !504
  %Conversion_ssdm_t = load i1* @Conversion_ssdm_thread_M_do_conversion, align 1, !dbg !506
  br i1 %Conversion_ssdm_t, label %1, label %2, !dbg !506

; <label>:1                                       ; preds = %0
  call void @"Conversion::do_conversion"(i1* %clk, i1* %reset, i8* %e, i8* %s), !dbg !507
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([11 x i8]* @p_str, i32 2, [14 x i8]* @p_str6) nounwind, !dbg !508
  call void (...)* @_ssdm_op_SpecSensitive([14 x i8]* @p_str6, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !509
  call void (...)* @_ssdm_op_SpecSensitive([14 x i8]* @p_str6, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !510
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !511
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !512
  call void (...)* @_ssdm_op_SpecInterface(i8* %e, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !513
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 4, [16 x i8]* @p_str13, [2 x i8]* @p_str9, i32 0, i32 0, i8* %e) nounwind, !dbg !514
  call void (...)* @_ssdm_op_SpecInterface(i8* %s, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !515
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 5, [16 x i8]* @p_str13, [2 x i8]* @p_str10, i32 0, i32 0, i8* %s) nounwind, !dbg !516
  ret void, !dbg !517
}
