...
define void @"Conversion::do_conversion"(i1* %clk, i1* %reset, i8* %e, i8* %s) {
  ...
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !61), !dbg !364
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !365), !dbg !364
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !366), !dbg !364
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !376), !dbg !364
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !386
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !388
  call void (...)* @_ssdm_op_SpecInterface(i8* %e, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !389
  call void (...)* @_ssdm_op_SpecInterface(i8* %s, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !390
  call void (...)* @_ssdm_op_SpecProcessDef([11 x i8]* @p_str, i32 2, [14 x i8]* @p_str6) nounwind, !dbg !391
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str7), !dbg !392
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str5) nounwind, !dbg !393
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !394
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !395), !dbg !394
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !397
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str7, i32 %tmp_2), !dbg !398
  br label %1, !dbg !399

; <label>:1                                       ; preds = %1, %0
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !400), !dbg !408
  %tmp = call i8 @_ssdm_op_Read.ap_fifo.volatile.i8P(i8* %e), !dbg !417
  call void @llvm.dbg.value(metadata !{i8 %tmp}, i64 0, metadata !419), !dbg !409
  %tmp_1 = add i8 %tmp, 1, !dbg !420
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !421), !dbg !427
  call void @_ssdm_op_Write.ap_fifo.volatile.i8P(i8* %s, i8 %tmp_1), !dbg !434
  br label %1, !dbg !436
}
...
define weak void @"Conversion::Conversion"(i1* %clk, i1* %reset, i8* %e, i8* %s) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %e), !map !53
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %s), !map !57
  call void @llvm.dbg.value(metadata !{i1* %clk}, i64 0, metadata !437), !dbg !440
  call void @llvm.dbg.value(metadata !{i1* %reset}, i64 0, metadata !441), !dbg !440
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !442), !dbg !440
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !443), !dbg !440
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !444), !dbg !450
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !451), !dbg !455
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !456), !dbg !463
  call void @llvm.dbg.value(metadata !{i8* %e}, i64 0, metadata !464), !dbg !468
  call void (...)* @_ssdm_op_SpecInterface(i8* %e, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !469
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str5, i32 4, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i8* %e) nounwind, !dbg !471
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !472), !dbg !477
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !478), !dbg !482
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !483), !dbg !490
  call void @llvm.dbg.value(metadata !{i8* %s}, i64 0, metadata !491), !dbg !495
  call void (...)* @_ssdm_op_SpecInterface(i8* %s, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !496
  call void (...)* @_ssdm_op_SpecPort([1 x i8]* @p_str5, i32 5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i8* %s) nounwind, !dbg !498
  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @p_str, [11 x i8]* @p_str) nounwind, !dbg !499
  %Conversion_ssdm_t = load i1* @Conversion_ssdm_thread_M_do_conversion, align 1, !dbg !501
  br i1 %Conversion_ssdm_t, label %1, label %2, !dbg !501

; <label>:1                                       ; preds = %0
  call void @"Conversion::do_conversion"(i1* %clk, i1* %reset, i8* %e, i8* %s), !dbg !502
  unreachable

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([11 x i8]* @p_str, i32 2, [14 x i8]* @p_str6) nounwind, !dbg !503
  call void (...)* @_ssdm_op_SpecSensitive([14 x i8]* @p_str6, [4 x i8]* @p_str2, i1* %clk, i32 1) nounwind, !dbg !504
  call void (...)* @_ssdm_op_SpecSensitive([14 x i8]* @p_str6, [6 x i8]* @p_str3, i1* %reset, i32 3) nounwind, !dbg !505
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %clk) nounwind, !dbg !506
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %reset) nounwind, !dbg !507
  call void (...)* @_ssdm_op_SpecInterface(i8* %e, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !508
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 4, [7 x i8]* @p_str13, [2 x i8]* @p_str9, i32 0, i32 0, i8* %e) nounwind, !dbg !509
  call void (...)* @_ssdm_op_SpecInterface(i8* %s, [8 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5, [1 x i8]* @p_str5, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str5, [1 x i8]* @p_str5) nounwind, !dbg !510
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str, i32 5, [7 x i8]* @p_str13, [2 x i8]* @p_str10, i32 0, i32 0, i8* %s) nounwind, !dbg !511
  ret void, !dbg !512
}
...
!402 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado/2017.3/common/technology/autopilot/ap_sysc/ap_sc_extras.h", metadata !"/home/cedric/Documents/Cours_2A/Toto/Projet_avance_SE/HLS", null} ; [ DW_TAG_file_type ]
