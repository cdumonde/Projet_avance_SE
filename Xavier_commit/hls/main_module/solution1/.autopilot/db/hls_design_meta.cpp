...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_din", 8, hls_out, 3, "ap_fifo", "fifo_data", 0),
	Port_Property("s_full_n", 1, hls_in, 3, "ap_fifo", "fifo_status", 0),
	Port_Property("s_write", 1, hls_out, 3, "ap_fifo", "fifo_update", 0),
};
const char* HLS_Design_Meta::dut_name = "top_level::top_level";
