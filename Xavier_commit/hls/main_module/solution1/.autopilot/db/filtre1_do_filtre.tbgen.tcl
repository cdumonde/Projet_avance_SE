...
set C_modelArgList {
	...
	{ filtre1_mem_x float 32 regular {array 1 { 0 3 } 0 1 }  }
	{ filtre1_mem_y float 32 regular {array 1 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "filtre1_y0", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "filtre1.y0","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "filtre1_mem_x", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "filtre1.mem_x","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "filtre1_mem_y", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "filtre1.mem_y","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtre1_fptrunc_6eOg_U28", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtre1_fpext_32nfYi_U29", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtre1_fpext_32nfYi_U30", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtre1_dadddsub_g8j_U31", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtre1_dmul_64nshbi_U32", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtre1_dmul_64nshbi_U33", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	filtre1_mem_x { ap_memory {  { filtre1_mem_x_address0 mem_address 1 1 }  { filtre1_mem_x_ce0 mem_ce 1 1 }  { filtre1_mem_x_we0 mem_we 1 1 }  { filtre1_mem_x_d0 mem_din 1 32 } } }
	filtre1_mem_y { ap_memory {  { filtre1_mem_y_address0 mem_address 1 1 }  { filtre1_mem_y_ce0 mem_ce 1 1 }  { filtre1_mem_y_we0 mem_we 1 1 }  { filtre1_mem_y_d0 mem_din 1 32 } } }
