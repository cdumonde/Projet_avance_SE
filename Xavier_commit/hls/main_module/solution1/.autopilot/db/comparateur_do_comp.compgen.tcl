...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_comparateur_in1 \
    op interface \
    ports { comparateur_in1 { O 32 vector } comparateur_in1_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_comparateur_seuil \
    op interface \
    ports { comparateur_seuil { O 32 vector } comparateur_seuil_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_comparateur_result \
    op interface \
    ports { comparateur_result { O 32 vector } comparateur_result_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_e1 \
    op interface \
    ports { e1_dout { I 32 vector } e1_empty_n { I 1 bit } e1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_e2 \
    op interface \
    ports { e2_dout { I 32 vector } e2_empty_n { I 1 bit } e2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s \
    op interface \
    ports { s_din { O 32 vector } s_full_n { I 1 bit } s_write { O 1 bit } } \
} "
}
