...
architecture behav of filtre1 is 
    ...
    "filtre1,hls_ip_2017_3,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.608000,HLS_SYN_LAT=24,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=25,HLS_SYN_FF=1885,HLS_SYN_LUT=1768}";
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_logic_0 : STD_LOGIC := '0';
    constant ap_const_boolean_1 : BOOLEAN := true;

    signal filtre1_mem_x_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal filtre1_mem_y_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_y0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_y0_ap_vld : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_x0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_x0_ap_vld : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_address0 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_ce0 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_we0 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_address1 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_ce1 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_we1 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_x_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_address0 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_ce0 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_we0 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_address1 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_ce1 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_we1 : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_filtre1_mem_y_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_e_read : STD_LOGIC;
    signal grp_filtre1_do_filtre_fu_72_s_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_filtre1_do_filtre_fu_72_s_write : STD_LOGIC;
    ...
    component filtre1_filtre1_mibs IS
    generic (
        DataWidth : INTEGER;
...
begin
    filtre1_mem_x_U : component filtre1_filtre1_mibs
    generic map (
        DataWidth => 32,
        AddressRange => 2,
        AddressWidth => 1)
    ...
    filtre1_mem_y_U : component filtre1_filtre1_mibs
    generic map (
        DataWidth => 32,
        AddressRange => 2,
        AddressWidth => 1)
    ...
    grp_filtre1_do_filtre_fu_72 : component filtre1_do_filtre
    port map (
        ap_clk => clk,
        ap_rst => reset,
