...
(* CORE_GENERATION_INFO="uart_wrapper,hls_ip_2017_3,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.608000,HLS_SYN_LAT=20,HLS_SYN_TPT=none,HLS_SYN_MEM=100,HLS_SYN_DSP=56,HLS_SYN_FF=7111,HLS_SYN_LUT=9743}" *)
...
wire    grp_top_level_fu_190_e_read;
wire   [31:0] grp_top_level_fu_190_s_din;
wire    grp_top_level_fu_190_s_write;
wire   [7:0] grp_uart_wrapper_do_action2_fu_306_s_din;
wire    grp_uart_wrapper_do_action2_fu_306_s_write;
wire    grp_uart_wrapper_do_action2_fu_306_FIFO_O_1_read;
wire    grp_uart_wrapper_do_action1_fu_422_e_read;
wire   [31:0] grp_uart_wrapper_do_action1_fu_422_FIFO_I_1_din;
wire    grp_uart_wrapper_do_action1_fu_422_FIFO_I_1_write;
...
assign e_read = grp_uart_wrapper_do_action1_fu_422_e_read;

assign s_din = grp_uart_wrapper_do_action2_fu_306_s_din;

assign s_write = grp_uart_wrapper_do_action2_fu_306_s_write;
