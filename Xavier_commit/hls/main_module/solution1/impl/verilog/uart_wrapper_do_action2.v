...
reg    FIFO_O_1_blk_n;
reg   [7:0] tmp_3_reg_222;
reg    ap_block_state2;
reg   [7:0] tmp_5_reg_227;
reg   [7:0] tmp_7_reg_232;
wire   [7:0] tmp_1_fu_187_p1;
wire   [31:0] buffer_fu_183_p1;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == FIFO_O_1_empty_n) | (1'b0 == s_full_n)) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_3_reg_222 <= {{buffer_fu_183_p1[15:8]}};
        tmp_5_reg_227 <= {{buffer_fu_183_p1[23:16]}};
        tmp_7_reg_232 <= {{buffer_fu_183_p1[31:24]}};
    end
end
...
assign buffer_fu_183_p1 = FIFO_O_1_dout;

assign tmp_1_fu_187_p1 = buffer_fu_183_p1[7:0];
