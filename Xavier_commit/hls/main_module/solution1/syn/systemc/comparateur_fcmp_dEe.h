...
#ifndef __comparateur_fcmp_dEe__HH__
#define __comparateur_fcmp_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(comparateur_fcmp_dEe) {
    ...
    SC_CTOR(comparateur_fcmp_dEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
