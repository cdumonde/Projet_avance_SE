...
#ifndef __filtre1_dadddsub_g8j__HH__
#define __filtre1_dadddsub_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filtre1_dadddsub_g8j) {
    ...
    SC_CTOR(filtre1_dadddsub_g8j):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
