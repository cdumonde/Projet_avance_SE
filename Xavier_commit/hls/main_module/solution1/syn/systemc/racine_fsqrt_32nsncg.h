...
#ifndef __racine_fsqrt_32nsncg__HH__
#define __racine_fsqrt_32nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(racine_fsqrt_32nsncg) {
    ...
    SC_CTOR(racine_fsqrt_32nsncg):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
