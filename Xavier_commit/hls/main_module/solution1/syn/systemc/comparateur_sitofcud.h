...
#ifndef __comparateur_sitofcud__HH__
#define __comparateur_sitofcud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(comparateur_sitofcud) {
    ...
    SC_CTOR(comparateur_sitofcud):  ACMP_sitofp_U ("ACMP_sitofp_U") {
