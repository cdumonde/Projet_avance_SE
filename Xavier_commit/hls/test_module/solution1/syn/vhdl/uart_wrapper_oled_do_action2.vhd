...
entity uart_wrapper_oled_do_action2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of uart_wrapper_oled_do_action2 is 
    ...
    signal tmp_3_reg_148 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state2 : BOOLEAN;
    signal tmp_5_reg_153 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_7_reg_158 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_113_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal buffer_fu_109_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_logic_0 = FIFO_O_1_empty_n) or (ap_const_logic_0 = s_full_n))) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                tmp_3_reg_148 <= buffer_fu_109_p1(15 downto 8);
                tmp_5_reg_153 <= buffer_fu_109_p1(23 downto 16);
                tmp_7_reg_158 <= buffer_fu_109_p1(31 downto 24);
            end if;
        end if;
    end process;
    ...
    buffer_fu_109_p1 <= FIFO_O_1_dout;
    ...
    s_din_assign_proc : process(s_full_n, FIFO_O_1_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, tmp_3_reg_148, tmp_5_reg_153, tmp_7_reg_158, tmp_1_fu_113_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state5) and (s_full_n = ap_const_logic_1))) then 
            s_din <= tmp_7_reg_158;
    ...
    tmp_1_fu_113_p1 <= buffer_fu_109_p1(8 - 1 downto 0);
end behav;
