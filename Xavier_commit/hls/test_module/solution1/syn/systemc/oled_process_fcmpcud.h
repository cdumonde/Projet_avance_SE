...
#ifndef __oled_process_fcmpcud__HH__
#define __oled_process_fcmpcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(oled_process_fcmpcud) {
    ...
    SC_CTOR(oled_process_fcmpcud):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
