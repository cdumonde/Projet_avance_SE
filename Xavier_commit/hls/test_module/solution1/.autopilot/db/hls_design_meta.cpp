...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("en", 1, hls_out, 4, "ap_vld", "out_data", 1),
	Port_Property("s_i", 6, hls_out, 5, "ap_vld", "out_data", 1),
};
const char* HLS_Design_Meta::dut_name = "uart_wrapper_oled::uart_wrapper_oled";
