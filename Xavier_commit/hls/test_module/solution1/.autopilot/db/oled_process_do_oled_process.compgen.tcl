...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name oled_process_sum \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_oled_process_sum \
    op interface \
    ports { oled_process_sum { O 32 vector } oled_process_sum_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name oled_process_save \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_oled_process_save \
    op interface \
    ports { oled_process_save { O 32 vector } oled_process_save_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_en \
    op interface \
    ports { en { O 1 bit } en_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s \
    op interface \
    ports { s { O 6 vector } s_ap_vld { O 1 bit } } \
} "
}
