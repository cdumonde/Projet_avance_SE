...
module uart_wrapper_oled_do_action1 (
        ap_clk,
        ap_rst,
        e_dout,
        e_empty_n,
...
reg    FIFO_I_1_blk_n;
reg   [7:0] tmp_reg_111;
reg   [7:0] tmp_4_reg_116;
reg   [7:0] tmp_6_reg_121;
reg    ap_block_state5;
wire   [31:0] buffer_fu_97_p5;
reg   [4:0] ap_NS_fsm;
...
assign FIFO_I_1_din = buffer_fu_97_p5;
...
assign buffer_fu_97_p5 = {{{{e_dout}, {tmp_6_reg_121}}, {tmp_4_reg_116}}, {tmp_reg_111}};

endmodule //uart_wrapper_oled_do_action1
