...
HD_PWD='Y:/Documents/MesDocuments/Cours_nsave/Enseirb-E3_nsave/pr310/git/Xavier_commit/vivado/full_chain/full_chain.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log turbo_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source turbo_uart.tcl -notrace
