...
HD_PWD='Y:/Documents/MesDocuments/Cours_nsave/Enseirb-E3_nsave/pr310/git/Xavier_commit/vivado/full_chain/full_chain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log turbo_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source turbo_uart.tcl
