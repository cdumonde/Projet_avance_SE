...
architecture behav of filtre1_do_filtre is 
    ...
    signal tmp_9_fu_155_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_9_reg_209 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_169_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_1_reg_214 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    filtre1_fptrunc_6eOg_U28 : component filtre1_fptrunc_6eOg
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 64,
    ...
    filtre1_fpext_32nfYi_U29 : component filtre1_fpext_32nfYi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    filtre1_fpext_32nfYi_U30 : component filtre1_fpext_32nfYi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        dout => tmp_9_fu_155_p1);

    filtre1_dadddsub_g8j_U31 : component filtre1_dadddsub_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    filtre1_dmul_64nshbi_U32 : component filtre1_dmul_64nshbi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    filtre1_dmul_64nshbi_U33 : component filtre1_dmul_64nshbi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    grp_fu_160_p1_assign_proc : process(reg_180, tmp_1_reg_214, ap_CS_fsm_state10, ap_CS_fsm_state16)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state16)) then 
            grp_fu_160_p1 <= reg_180;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            grp_fu_160_p1 <= tmp_1_reg_214;
        else 
