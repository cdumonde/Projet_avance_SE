...
#
# Generated by export_simulation on Thu Dec 21 16:37:31 +0100 2017
#
################################################################################
...
'-reset_run' switch to the './top_level_0.sh' script.

./top_level_0.sh -reset_run
...
./top_level_0.sh -noclean_files

For more information on the script, please type './top_level_0.sh -help'.
