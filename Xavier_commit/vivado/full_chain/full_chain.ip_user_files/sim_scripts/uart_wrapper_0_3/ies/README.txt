...
#
# Generated by export_simulation on Thu Jan 18 14:48:22 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './uart_wrapper_0.sh' script.

./uart_wrapper_0.sh -reset_run
...
./uart_wrapper_0.sh -noclean_files

For more information on the script, please type './uart_wrapper_0.sh -help'.
