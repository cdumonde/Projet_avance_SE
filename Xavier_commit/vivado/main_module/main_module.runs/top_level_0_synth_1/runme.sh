...
HD_PWD='Y:/Documents/MesDocuments/Cours_nsave/Enseirb-E3_nsave/pr310/git/Xavier_commit/vivado/main_module/main_module.runs/top_level_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_0.tcl
