...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Conversion_1 xil_defaultlib.Conversion_1 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Conversion_1 -key {Behavioral:sim_1:Functional:Conversion_1} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Vivado_Design_Suite/Vivado/2017.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Conversion_1.wdb xsim.dir)
