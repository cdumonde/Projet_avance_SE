...
#
# Generated by export_simulation on Fri Nov 10 11:36:44 +0100 2017
#
################################################################################
...
'-reset_run' switch to the './Conversion_1.sh' script.

./Conversion_1.sh -reset_run
...
./Conversion_1.sh -noclean_files

For more information on the script, please type './Conversion_1.sh -help'.
