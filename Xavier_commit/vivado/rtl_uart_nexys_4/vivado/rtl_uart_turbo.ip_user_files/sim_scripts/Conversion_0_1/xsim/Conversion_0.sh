...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Conversion_0 xil_defaultlib.Conversion_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Conversion_0 -key {Behavioral:sim_1:Functional:Conversion_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Conversion_0.wdb xsim.dir)
