...
#
# Generated by export_simulation on Fri Nov 10 11:28:59 +0100 2017
#
################################################################################
...
'-reset_run' switch to the './Conversion_0.sh' script.

./Conversion_0.sh -reset_run
...
./Conversion_0.sh -noclean_files

For more information on the script, please type './Conversion_0.sh -help'.
